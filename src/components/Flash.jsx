...
function SampleNextArrow(props) {
  ...
  return (
    ...
    > 
     ...
     <div className='absolute -top-112 right-36.75 w-12 h-12 rounded-full bg-[#f5f5f5] hidden lg:flex justify-center items-center duration-300 hover:text-white text-black hover:bg-black'><FaArrowLeft className=' text-2xl ' /></div>
