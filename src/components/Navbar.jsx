            ...
            <nav className=' py-7 border-b border-black'>
                <Container>
                    <Flex className={'flex justify-between relative z-10'}>
                        ...
                        <div className={`${show ? 'opacity-100 translate-y-0 visible' : 'opacity-0 -translate-y-3 invisible'} lg:opacity-100 translate-y-0 visible transition-all duration-300 ease-in-out absolute  top-15.5 mb:top-5.5 md:left-52.25 lg:static bg-black lg:bg-white text-white lg:text-black p- lg:p-0 rounded-[14px]  lg:flex justify-center gap-60.75`}>
