...
const Crad = ({ cradImg, cradText, price, disPrice, review,Red_discoun,ster }) => {
    return (
        <>
            <div className='w-67.5 group'>
                <div className=' relative w-fit overflow-hidden '>
                    <Flex className=' w-56.75 h-62.5 bg-[#f5f5f5]  items-center justify-center relative'>
                        ...
                        <div className=' absolute top-3 left-3 flex gap-24.25 '>
                ...
                <h2 className=' w-50 font-medium font-famailyP text-black mt-4 mb-2'>{cradText}</h2>
                <div className=' flex gap-3 mb-2'>
                    <h2 className=' text-p'>${price}</h2>
                    <h2 className=' line-through text-[#808080]'>{disPrice}</h2>
                </div>
                <Flex className='items-center gap-2'>


                     <Rate allowHalf defaultValue={ster} />
                     

               
                    <h2 className=' text-[#808080]'>({review})</h2>
                </Flex>
            </div>
