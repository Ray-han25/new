        ...
        <Container>
          <Flex className='flex-wrap justify-between'>
            <Flex className='flex-col gap-y-6'>
              ...
              <Flex className=' pr-4 justify-center items-center w-54.25 h-12 rounded-sm border border-white '><input className='pl-4 py-4 text-white border-none outline-none' type="text" placeholder='Enter your email' />
